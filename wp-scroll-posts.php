...
add_action('wp_enqueue_scripts', 'wp_comments_styles_wpsp');
function wp_comments_styles_wpsp() {
    wp_register_style('styles_wpsp_css', plugins_url('css/styles.css', __FILE__));
    wp_enqueue_style('styles_wpsp_css');
  }
...
<li class="box">                
                  <p class="img-box"><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_post_thumbnail('small'); ?></a></p>
                    <div class="detail">
					<?php //the_post_thumbnail();?>
					<h3><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h3>
                    <p><?php the_excerpt()?></p>                    
                     <a href="<?php the_permalink(); ?>" class="readmore"><?php echo get_option('wpsp_readmore'); ?> </a>
                  </div>
                </li>
				<?php endwhile; endif; ?>
				</ul>              
            </div>
			<?php // wp_pagenavi(); //wp_paginate();  //wp_pagenavi();;wp_paginate();
				  // output ends 
				  }
